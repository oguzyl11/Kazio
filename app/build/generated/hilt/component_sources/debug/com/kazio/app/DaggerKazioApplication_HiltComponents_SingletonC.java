...
import com.kazio.app.di.DatabaseModule_ProvidePersonalRecordDaoFactory;
...
import com.kazio.app.domain.usecase.CheckAndUpdateRecordsUseCase;
...
import com.kazio.app.presentation.premium.PremiumViewModel;
import com.kazio.app.presentation.premium.PremiumViewModel_HiltModules;
import com.kazio.app.presentation.settings.SettingsViewModel;
...
import com.kazio.app.presentation.transactions.TransactionsViewModel;
import com.kazio.app.presentation.transactions.TransactionsViewModel_HiltModules;
...
public final class DaggerKazioApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends KazioApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>builderWithExpectedSize(8).put(LazyClassKeyProvider.com_kazio_app_presentation_addexpense_AddExpenseViewModel, AddExpenseViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_addincome_AddIncomeViewModel, AddIncomeViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_auth_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_premium_PremiumViewModel, PremiumViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_settings_SettingsViewModel, SettingsViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_summary_SummaryViewModel, SummaryViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_kazio_app_presentation_transactions_TransactionsViewModel, TransactionsViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      ...
      static String com_kazio_app_presentation_settings_SettingsViewModel = "com.kazio.app.presentation.settings.SettingsViewModel";

      static String com_kazio_app_presentation_transactions_TransactionsViewModel = "com.kazio.app.presentation.transactions.TransactionsViewModel";

      static String com_kazio_app_presentation_premium_PremiumViewModel = "com.kazio.app.presentation.premium.PremiumViewModel";
      ...
      @KeepFieldType
      SettingsViewModel com_kazio_app_presentation_settings_SettingsViewModel2;

      @KeepFieldType
      TransactionsViewModel com_kazio_app_presentation_transactions_TransactionsViewModel2;

      @KeepFieldType
      PremiumViewModel com_kazio_app_presentation_premium_PremiumViewModel2;
  ...
  private static final class ViewModelCImpl extends KazioApplication_HiltComponents.ViewModelC {
    ...
    private CheckAndUpdateRecordsUseCase checkAndUpdateRecordsUseCase() {
      return new CheckAndUpdateRecordsUseCase(singletonCImpl.bindPersonalRecordRepositoryProvider.get(), singletonCImpl.getSummaryUseCase());
    }

    private AddExpenseUseCase addExpenseUseCase() {
      return new AddExpenseUseCase(singletonCImpl.bindExpenseRepositoryProvider.get(), checkAndUpdateRecordsUseCase());
    }
    ...
    private GetRecentFrequentExpensesUseCase getRecentFrequentExpensesUseCase() {
      return new GetRecentFrequentExpensesUseCase(singletonCImpl.bindExpenseRepositoryProvider.get());
    }
    ...
    private AddIncomeUseCase addIncomeUseCase() {
      return new AddIncomeUseCase(singletonCImpl.bindIncomeRepositoryProvider.get(), checkAndUpdateRecordsUseCase());
    }

    private UpdateIncomeUseCase updateIncomeUseCase() {
      return new UpdateIncomeUseCase(singletonCImpl.bindIncomeRepositoryProvider.get());
    }

    private GetRecentFrequentIncomesUseCase getRecentFrequentIncomesUseCase() {
      return new GetRecentFrequentIncomesUseCase(singletonCImpl.bindIncomeRepositoryProvider.get());
    }

    private GetActiveShiftIncomeUseCase getActiveShiftIncomeUseCase() {
      return new GetActiveShiftIncomeUseCase(singletonCImpl.bindIncomeRepositoryProvider.get());
    }

    private GetStreakUseCase getStreakUseCase() {
      return new GetStreakUseCase(singletonCImpl.bindIncomeRepositoryProvider.get(), singletonCImpl.bindExpenseRepositoryProvider.get());
    }
    ...
    private EndShiftUseCase endShiftUseCase() {
      return new EndShiftUseCase(singletonCImpl.bindShiftRepositoryProvider.get(), getActiveShiftUseCase(), getActiveShiftIncomeUseCase(), checkAndUpdateRecordsUseCase());
    }

    private PauseShiftUseCase pauseShiftUseCase() {
      return new PauseShiftUseCase(singletonCImpl.bindShiftRepositoryProvider.get(), getActiveShiftUseCase());
    }

    private ResumeShiftUseCase resumeShiftUseCase() {
      return new ResumeShiftUseCase(singletonCImpl.bindShiftRepositoryProvider.get(), getActiveShiftUseCase());
    }

    private GenerateReportUseCase generateReportUseCase() {
      return new GenerateReportUseCase(singletonCImpl.bindShiftRepositoryProvider.get(), singletonCImpl.bindIncomeRepositoryProvider.get(), singletonCImpl.bindExpenseRepositoryProvider.get());
    }

    private GetPersonalRecordsUseCase getPersonalRecordsUseCase() {
      return new GetPersonalRecordsUseCase(singletonCImpl.bindPersonalRecordRepositoryProvider.get());
    }

    private DeleteIncomeUseCase deleteIncomeUseCase() {
      return new DeleteIncomeUseCase(singletonCImpl.bindIncomeRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.summaryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.transactionsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>builderWithExpectedSize(8).put(LazyClassKeyProvider.com_kazio_app_presentation_addexpense_AddExpenseViewModel, ((Provider) addExpenseViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_addincome_AddIncomeViewModel, ((Provider) addIncomeViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_auth_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_premium_PremiumViewModel, ((Provider) premiumViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_settings_SettingsViewModel, ((Provider) settingsViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_summary_SummaryViewModel, ((Provider) summaryViewModelProvider)).put(LazyClassKeyProvider.com_kazio_app_presentation_transactions_TransactionsViewModel, ((Provider) transactionsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AddExpenseViewModel(viewModelCImpl.getActiveShiftUseCase(), viewModelCImpl.addExpenseUseCase(), viewModelCImpl.updateExpenseUseCase(), viewModelCImpl.getRecentFrequentExpensesUseCase());

          case 1: // com.kazio.app.presentation.addincome.AddIncomeViewModel 
          return (T) new AddIncomeViewModel(viewModelCImpl.getPlatformsUseCase(), viewModelCImpl.getActiveShiftUseCase(), viewModelCImpl.addIncomeUseCase(), viewModelCImpl.updateIncomeUseCase(), viewModelCImpl.getRecentFrequentIncomesUseCase());
          ...
          return (T) new DashboardViewModel(singletonCImpl.getSummaryUseCase(), singletonCImpl.getRecommendationsUseCase(), viewModelCImpl.getActiveShiftUseCase(), viewModelCImpl.getActiveShiftIncomeUseCase(), viewModelCImpl.getStreakUseCase(), viewModelCImpl.startShiftUseCase(), viewModelCImpl.endShiftUseCase(), viewModelCImpl.pauseShiftUseCase(), viewModelCImpl.resumeShiftUseCase(), viewModelCImpl.generateReportUseCase(), singletonCImpl.dataStoreRepositoryProvider.get(), singletonCImpl.bindPersonalRecordRepositoryProvider.get());

          case 4: // com.kazio.app.presentation.premium.PremiumViewModel 
          return (T) new PremiumViewModel(singletonCImpl.billingManagerProvider.get(), singletonCImpl.dataStoreRepositoryProvider.get());

          case 5: // com.kazio.app.presentation.settings.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.dataStoreRepositoryProvider.get());

          case 6: // com.kazio.app.presentation.summary.SummaryViewModel 
          return (T) new SummaryViewModel(singletonCImpl.getSummaryUseCase(), viewModelCImpl.generateReportUseCase(), viewModelCImpl.getPersonalRecordsUseCase(), singletonCImpl.dataStoreRepositoryProvider.get());

          case 7: // com.kazio.app.presentation.transactions.TransactionsViewModel 
          return (T) new TransactionsViewModel(singletonCImpl.bindIncomeRepositoryProvider.get(), singletonCImpl.bindExpenseRepositoryProvider.get(), viewModelCImpl.deleteIncomeUseCase(), viewModelCImpl.deleteExpenseUseCase());
  ...
  private static final class SingletonCImpl extends KazioApplication_HiltComponents.SingletonC {
    ...
    private Provider<PersonalRecordRepositoryImpl> personalRecordRepositoryImplProvider;

    private Provider<PersonalRecordRepository> bindPersonalRecordRepositoryProvider;
    ...
    private PersonalRecordDao personalRecordDao() {
      return DatabaseModule_ProvidePersonalRecordDaoFactory.providePersonalRecordDao(provideKazioDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.shiftRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 4);
      this.bindShiftRepositoryProvider = DoubleCheck.provider((Provider) shiftRepositoryImplProvider);
      this.dataStoreRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DataStoreRepository>(singletonCImpl, 5));
      this.personalRecordRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 6);
      this.bindPersonalRecordRepositoryProvider = DoubleCheck.provider((Provider) personalRecordRepositoryImplProvider);
      this.billingManagerProvider = DoubleCheck.provider(new SwitchingProvider<BillingManager>(singletonCImpl, 7));
    }
    ...
    public GetSummaryUseCase getSummaryUseCase() {
      return new GetSummaryUseCase(bindIncomeRepositoryProvider.get(), bindExpenseRepositoryProvider.get(), bindPlatformRepositoryProvider.get(), bindShiftRepositoryProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 4: // com.kazio.app.data.repository.ShiftRepositoryImpl 
          return (T) new ShiftRepositoryImpl(singletonCImpl.shiftDao());

          case 5: // com.kazio.app.data.local.datastore.DataStoreRepository 
          ...
          case 6: // com.kazio.app.data.repository.PersonalRecordRepositoryImpl 
          return (T) new PersonalRecordRepositoryImpl(singletonCImpl.personalRecordDao());

          case 7: // com.kazio.app.data.billing.BillingManager 
          return (T) new BillingManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.dataStoreRepositoryProvider.get());
