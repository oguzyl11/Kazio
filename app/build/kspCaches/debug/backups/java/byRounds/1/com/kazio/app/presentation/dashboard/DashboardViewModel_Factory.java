...
public final class DashboardViewModel_Factory implements Factory<DashboardViewModel> {
  ...
  public DashboardViewModel get() {
    return newInstance(getSummaryUseCaseProvider.get(), getRecommendationsUseCaseProvider.get(), getActiveShiftUseCaseProvider.get(), startShiftUseCaseProvider.get(), endShiftUseCaseProvider.get(), dataStoreRepositoryProvider.get());
  }
  ...
  public static DashboardViewModel_Factory create(
      ...
      Provider<EndShiftUseCase> endShiftUseCaseProvider,
      Provider<DataStoreRepository> dataStoreRepositoryProvider) {
    return new DashboardViewModel_Factory(getSummaryUseCaseProvider, getRecommendationsUseCaseProvider, getActiveShiftUseCaseProvider, startShiftUseCaseProvider, endShiftUseCaseProvider, dataStoreRepositoryProvider);
  }
  ...
  public static DashboardViewModel newInstance(GetSummaryUseCase getSummaryUseCase,
    ...
    return new DashboardViewModel(getSummaryUseCase, getRecommendationsUseCase, getActiveShiftUseCase, startShiftUseCase, endShiftUseCase, dataStoreRepository);
  }
}
